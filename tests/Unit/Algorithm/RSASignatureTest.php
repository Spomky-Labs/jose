...
class RSASignatureTest extends TestCase
{
    ...
    public function testCompleteRS256SignWithDetachedPayload()
    {
        ...
        $jws = JWSFactory::createEmptyJWSWithDetachedPayload('Live long and Prosper.', $encoded_payload);
    ...
    {
        $decrypter = DecrypterFactory::createDecrypter(['RSA1_5', 'A128CBC-HS256'], ['DEF']);
    ...
    {
        $decrypter = DecrypterFactory::createDecrypter(['RSA1_5', 'A128KW', 'A128CBC-HS256'], ['DEF']);
