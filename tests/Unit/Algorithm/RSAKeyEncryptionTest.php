...
class RSAKeyEncryptionTest extends TestCase
{
    ...
    public function testLoadJWK1()
    {
        ...
        $decrypter = DecrypterFactory::createDecrypter(['RSA-OAEP', 'A256GCM'], ['DEF'], $this->getCheckers());
    ...
    public function testLoadJWK2()
    {
        ...
        $this->assertInstanceOf('Jose\Object\JWEInterface', $loaded);
        //$this->assertEquals('RSA1_5', $loaded->getHeader('alg'));
    ...
    {
        $decrypter = DecrypterFactory::createDecrypter(['A128CBC-HS256', 'A128KW'], ['DEF'], $this->getCheckers());
