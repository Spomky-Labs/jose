...
{
    /**
     * Please note that we cannot create create the signature and get the same result as the example (ECDSA signatures are always different).
    ...
    public function testES512()
    {
        ...
        $this->assertEquals(0, $verifer->verifyWithKey($jws, $private_key));
