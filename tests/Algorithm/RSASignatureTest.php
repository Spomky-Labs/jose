...
class RSASignatureTest extends TestCase
{
    ...
    public function testCompleteRS256SignWithDetachedPayload()
    {
        ...
        $signature = $signer->addSignatureWithDetachedPayload(
            $jws,
            $key,
            $encoded_payload,
            [
    ...
    {
        $decrypter = DecrypterFactory::createDecrypter(['RSA1_5', 'A128CBC-HS256'], ['DEF'], $this->getCheckers());
    ...
    {
        $decrypter = DecrypterFactory::createDecrypter(['RSA1_5', 'A128KW', 'A128CBC-HS256'], ['DEF'], $this->getCheckers());
